...
// прежнюю цифру, и взять её было больше неоткуда. Замок должен держать цифру от ВСЕГО:
// от кнопки, от воскресного cron и от ручной правки. Снять его можно только отдельным
// действием — в этом вся защита.
